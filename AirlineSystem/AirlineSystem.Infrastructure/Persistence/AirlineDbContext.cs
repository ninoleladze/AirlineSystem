...
namespace AirlineSystem.AirlineSystem.Infrastructure.Persistence
{
    internal class AirlineDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=(localdb)\ProjectModels;Initial Catalog=AirlineSystem1_DB;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
